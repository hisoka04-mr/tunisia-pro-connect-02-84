...
-- First, ensure the messages table has the correct structure
...
-- Update notifications policies to allow system inserts
...
-- Try to add tables to realtime (ignore errors if already exists)
DO $$ 
BEGIN
