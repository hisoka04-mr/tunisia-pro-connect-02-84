  ...
  const [testimonials] = useState([
    {
      ...
      name: "Ahmed Ben Ali",
      role: "Homeowner",
      content: "ServiGOTN saved me during a major plumbing emergency. The plumber arrived within an hour and fixed the issue efficiently. The transparent pricing was a plus!",
    ...
    },
    {
      ...
      content: "I've used ServiGOTN multiple times for electrical work. The professionals are always polite, skilled, and clean up after themselves. Highly recommended!",
    ...
    },
    {
      ...
      name: "Karim Bouazizi",
      role: "Business Owner", 
      content: "As a cafe owner, I need reliable services for my business. ServiGOTN has been my go-to for all maintenance needs. The quality of service is exceptional.",
