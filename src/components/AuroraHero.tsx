    ...
    <AuroraBackground>
      ...
      >
        <div className="max-w-3xl mx-auto text-center mb-8">
          <h1 className="text-4xl md:text-7xl font-bold mb-4 text-servigo-dark">
        ...
        <motion.div 
          ...
          className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-4xl"
        >
          <div className="bg-card/80 backdrop-blur-sm p-6 rounded-lg shadow-md border border-border/50">
